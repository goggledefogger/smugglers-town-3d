...
export class TerrainMesh {
  ...
  private _mode: 'photoreal' | 'masked-tiles' | 'best-3d' | 'best-3d-plus' | 'painted-3d' | 'game3d' = 'photoreal';
  ...
  setMode(mode: 'photoreal' | 'masked-tiles' | 'best-3d' | 'best-3d-plus' | 'painted-3d' | 'game3d'): void {
    this._mode = mode;
