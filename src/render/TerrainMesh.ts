...
export class TerrainMesh {
  ...
  private _mode: 'photoreal' | 'masked-tiles' | 'projected-3d-tiles' | 'projected-2d-maps' | 'projected-3d' | 'game3d' | 'game3d-textured' | 'game3d-planar' | 'game3d-hybrid' = 'photoreal';
  ...
  setMode(mode: 'photoreal' | 'masked-tiles' | 'projected-3d-tiles' | 'projected-2d-maps' | 'projected-3d' | 'game3d' | 'game3d-textured' | 'game3d-planar' | 'game3d-hybrid'): void {
    this._mode = mode;
