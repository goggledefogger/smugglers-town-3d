...
export class HealthBar extends HudComponent {
  static override styles = css`
    :host { display: block; }
    .panel { padding:8px 12px; background:rgba(36,28,22,.82); border:1px solid var(--line); border-radius:10px; }
    .lab { display:flex; justify-content:space-between; font-size:10px; letter-spacing:.14em;
      text-transform:uppercase; color:var(--muted); margin-bottom:4px; }
    .bar { height:8px; background:#000; border-radius:6px; overflow:hidden; border:1px solid var(--line); }
